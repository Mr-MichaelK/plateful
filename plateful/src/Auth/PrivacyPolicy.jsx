...
function PrivacyPolicy() {
  return (
    <div className="flex flex-col min-h-screen bg-[#FFF8F0] text-gray-900">
      <main className="flex-grow w-full max-w-3xl mx-auto px-6 py-12">
        <h1
          className="text-4xl font-bold text-center mb-10 text-[#800020]"
        ...
        <section className="mb-12">
          ...
          <p className="text-sm leading-relaxed text-gray-600 mb-4">
            This Privacy Policy explains how Plateful collects, stores, and
            uses information. By using Plateful, you agree to the practices
            described here.
          </p>
          <p className="text-sm leading-relaxed text-gray-600 mb-4">
